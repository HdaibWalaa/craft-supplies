...
class OrderResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return ['id' => (string) $this->id, 'orderNumber' => $this->order_number, 'accessToken' => $this->access_token, 'email' => $this->email,
            ...
            'shippingMethod' => ['id' => $this->shipping_method_id, 'name' => $this->shipping_method_name ?? $this->shipping_method,
                'estimatedDaysMin' => $this->shipping_estimated_days_min, 'estimatedDaysMax' => $this->shipping_estimated_days_max],
            'shippingZone' => ['id' => $this->shipping_zone_id, 'name' => $this->shipping_zone_name],
            'shippingAddress' => $this->shipping_address, 'billingAddress' => $this->billing_address,
