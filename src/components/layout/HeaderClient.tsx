...
export function HeaderClient({
  ...
  const staticLinks = [
    ...
    { href: "/blog", label: t("tutorialsIdeas") },
      ...
      <div className="flex h-20 items-center gap-4 py-3 md:h-24">
        ...
        <nav className="ms-6 hidden items-center gap-1 md:flex">
          ...
          >
            ...
            {megaOpen ? (
              <div className="absolute start-0 top-full w-[36rem] rounded-3xl border border-ink-200 bg-cream-50 p-4 shadow-[var(--shadow-card-hover)]">
        ...
        <div className="ms-auto flex items-center gap-1 sm:gap-2">
          ...
          <div className="relative">
            ...
            {accountOpen ? (
              <div className="absolute end-0 top-full mt-1 w-52 rounded-xl border border-ink-200 bg-cream-50 p-1.5 shadow-[var(--shadow-card-hover)]">
                {user ? (
                  <>
                    ...
                    <form action={signOutAction}>
                      <button type="submit" className="flex w-full cursor-pointer items-center gap-2 rounded-md px-3 py-2 text-start text-sm text-ink-800 hover:bg-terracotta-50">
          ...
          >
            ...
            {cartCount > 0 ? (
              <span className="absolute -end-0.5 -top-0.5 flex h-4.5 w-4.5 min-w-4.5 items-center justify-center rounded-full bg-terracotta-600 px-1 text-[10px] font-bold text-cream-50">
                {cartCount}
              </span>
            ) : null}
          </Link>
