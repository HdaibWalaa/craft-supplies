...
const routes: Array<{ path: string; page: unknown; protected?: boolean; title?: string; description?: string }> = [
  ...
  { path: "/cart", page: CartPage, title: "Your Cart" }, { path: "/checkout", page: CheckoutPage, title: "Checkout" }, { path: "/checkout/success", page: CheckoutSuccessPage, title: "Order Confirmation" }, { path: "/search", page: SearchPage, title: "Search Results" },
  ...
  { path: "/blog", page: BlogPage }, { path: "/blog/:slug", page: BlogPostPage }, { path: "/about", page: AboutPage }, { path: "/contact", page: ContactPage }, { path: "/faq", page: FaqPage, title: "Frequently Asked Questions" }, { path: "/shipping-returns", page: ShippingReturnsPage, title: "Shipping & Returns" }, { path: "/privacy", page: PrivacyPage, title: "Privacy Policy" }, { path: "/terms", page: TermsPage, title: "Terms of Service" },
];
