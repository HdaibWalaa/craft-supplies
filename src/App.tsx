...
function NotFound() { useEffect(() => { document.title = "Page Not Found | Kiln & Wick Craft Supply"; }, []); return <div className="mx-auto max-w-3xl px-4 py-24 text-center"><h1 className="font-display text-4xl font-semibold text-ink-900">Page not found</h1><p className="mt-3 text-ink-500">The page you requested does not exist.</p></div>; }
